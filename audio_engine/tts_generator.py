...
Also supports generating a single TTS MP3 for a given text.
"""
...
def generate_tts_audio(
    ...
    """
    Generate a single TTS MP3 file from text using gTTS.
    ...
    try:
        ...
        raise RuntimeError(
            f"Failed to generate TTS for text '{text[:50]}...': {exc}"
        ) from exc
